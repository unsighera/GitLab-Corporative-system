							...
							Если ОбходПоСчетамУчета.СуммаДоходов <> 0 
								...
								Для каждого НаправлениеРаспределения Из ТаблицаБазы Цикл
									...
									Если ИспользуетсяБазаРаспределенияПоПроектам Тогда    
										...
										СуммаЗатрат = ?(СуммаКРаспределению = 0, 0, НаправлениеРаспределения.База * СуммаКРаспределению / ВсегоБазаРаспределенияПоПроектам);
										
									Иначе   
										
										СуммаЗатрат = ?(СуммаКРаспределению = 0, 0, НаправлениеРаспределения.База * СуммаКРаспределению / ВсегоБазаРаспределения);
