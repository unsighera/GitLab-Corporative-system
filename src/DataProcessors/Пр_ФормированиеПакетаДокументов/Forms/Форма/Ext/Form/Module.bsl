...
Функция НачатьФормированиеДокументов()
	...
	Если ЗначениеЗаполнено(ПериодФормирования.ДатаОкончания) 
		 И ЗначениеЗаполнено(ПериодФормирования.ДатаНачала)
	Тогда
		СтруктураПериода.Вставить("ДатаНачала", ПериодФормирования.ДатаНачала);
		СтруктураПериода.Вставить("ДатаОкончания", ПериодФормирования.ДатаОкончания);
	КонецЕсли;
	...
	МассивДокументов, СтруктураПериода);
